...
var _DiceContainer = require('./DiceContainer');

var _DiceContainer2 = _interopRequireDefault(_DiceContainer);
  ...
  _createClass(ReactDice, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_DiceContainer2.default, _extends({}, this.props, { totalCb: this.totalCb,
          ref: function ref(c) {
...
ReactDice.propTypes = {
  ...
  dieSize: _react.PropTypes.number,
  disableIndividual: _react.PropTypes.bool,
  margin: _react.PropTypes.number,
  numDice: _react.PropTypes.number,
  sides: _react.PropTypes.number,
  rollTime: _react.PropTypes.number,
  rollDone: _react.PropTypes.function,
  faceColor: _react.PropTypes.string,
